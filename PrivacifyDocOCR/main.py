...
def setup_queues(channel):
    ...
    channel.queue_declare(queue='document_upload_completed', durable=True)
...
def on_message_received(ch, method, properties, body):
    ...
    try:
        ...
        # Publish the results to the OCR completion queue
        ch.basic_publish(
            exchange='',
            routing_key='document_ocr_completed',
...
def main():
    ...
    channel.basic_consume(queue='document_upload_completed', on_message_callback=on_message_received)
